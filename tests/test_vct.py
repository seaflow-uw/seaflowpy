...
class TestOpen:
    def test_read_VCT(self):
        vct = sfp.VCT("tests/testcruise_vct/2014_185/2014-07-04T00-03-02+00-00.vct")
    ...
    def test_read_VCT_gz(self):
        vct = sfp.VCT("tests/testcruise_vct/2014_185/2014-07-04T00-00-02+00-00.vct.gz")
...
class TestPathFilenamParsing:
    def test_is_vct(self):
        files = [
            ...
            "testcruise_vct/2014_185/100.vct",
    ...
    def test_find_vct_file(self):
        files = sfp.find_vct_files("tests/testcruise_vct")
        assert files == [
